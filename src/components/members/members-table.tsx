...
import { buildMemberExportColumns } from "@/lib/member-export-columns";
...
export function MembersTable() {
  ...
  const exportColumns = useMemo(
    () => buildMemberExportColumns({ sectorNameById }),
    [sectorNameById],
  );
            ...
            <div className="flex items-center gap-2 justify-end flex-wrap">
              ...
              {isAdmin && (
                <ExportExcelButton
                  ...
                  fileName={`miembros-${new Date().toISOString().slice(0, 10)}`}
                  sheetName="Miembros"
                  label="Exportar"
                />
              )}
